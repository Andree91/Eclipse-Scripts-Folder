...
public class SelectFacialHairColor : MonoBehaviour
{
    [Header("Color Values")]
    ...
    {
        currentFacialHairColor = new Color(redAmount, greenAmount, blueAmount);//, alphaAmount);

        for (int i = 0; i < rendererList.Count; i++)
        {
            //If usin SYNTY models
            rendererList[i].material.SetColor("_Color_Hair", currentFacialHairColor);
