...
public class SelectEyebrowColor : MonoBehaviour
{
    [Header("Color Values")]
    ...
    {
        currentEyebrowColor = new Color(redAmount, greenAmount, blueAmount);//, alphaAmount);

        for (int i = 0; i < rendererList.Count; i++)
        {
            //If usin SYNTY models
            rendererList[i].material.SetColor("_Color_Hair", currentEyebrowColor);
