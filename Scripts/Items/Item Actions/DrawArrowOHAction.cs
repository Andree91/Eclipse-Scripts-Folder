...
namespace AG
{
    [CreateAssetMenu(menuName = "Item Actions/Draw Arrow OH Action")]
    public class DrawArrowOHAction : ItemAction
    {
        public FireArrowAction fireArrowAction;
        ...
        public override void PerformAction(CharacterManager character)
        {
            ...
            if (character.characterInventoryManager.currentAmmo01 != null || !character.characterInventoryManager.currentAmmo01.isEmpty)
            {
