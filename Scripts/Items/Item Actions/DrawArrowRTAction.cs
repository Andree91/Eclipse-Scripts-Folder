...
namespace AG
{
    [CreateAssetMenu(menuName = "Item Actions/Draw Arrow RT Action")]
    public class DrawArrowRTAction : ItemAction
    {
        public override void PerformAction(CharacterManager character)
        {
            ...
            if (character.characterInventoryManager.currentAmmo02 != null)
            {
                if (character.characterInventoryManager.currentAmmo02.currentAmmo > 0)
                {
                    //Animate The Player
                    ...
                    GameObject loadedArrow = Instantiate(character.characterInventoryManager.currentAmmo02.loadedItemModel, character.characterWeaponSlotManager.leftHandSlot.transform);
